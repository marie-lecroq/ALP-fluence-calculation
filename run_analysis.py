...
for lgm, lgg in local_partition:
    # Here, just get the result (fluence). Use the alternative function to save intermediate results.
    res = expected_photon_fluence(10**lgm,10**(lgg-9.0))[2]
    #print('{:.3f} {:.3f} {:.10e}'.format(lgm,lgg,res), flush=True)
